...
import pricingEquity from "../../media/pricingEquity.svg";
import intradayTrades from "../../media/intradayTrades.svg";
    ...
    <div className="container">
      ...
      <div className="row p-5 mt-5 text-center">
        <div className="col-4 p-4">
          <img src={pricingEquity} alt="Free equity delivery" />
        ...
        <div className="col-4 p-4">
          <img src={pricingEquity} alt="Free direct MF" />
